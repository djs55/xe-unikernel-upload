...
(* OASIS_START *)
(* DO NOT EDIT (digest: b78f9be66f2f3038500539a8b9a28d46) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mbr-format.lwt", None);
                           FindlibPackage ("mbr-format.mirage", None);
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\014[>A\223\003\172`\177\229\229\186\157\007\157Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
